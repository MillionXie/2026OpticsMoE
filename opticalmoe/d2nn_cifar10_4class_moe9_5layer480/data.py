...
def create_loaders(config, seed=7, smoke_test=False):
    ...
    transform = transforms.Compose([
        ...
        # Nearest-neighbor preserves source gray levels instead of inventing
        # interpolated optical-input values.
    ...
    kwargs = {"batch_size": int(cfg.get("batch_size", 16)), "num_workers": int(cfg.get("num_workers", 4)), "pin_memory": torch.cuda.is_available()}
