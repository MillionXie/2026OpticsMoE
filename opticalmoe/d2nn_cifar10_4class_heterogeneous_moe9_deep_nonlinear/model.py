"""CIFAR-10 deep heterogeneous nine-expert staged OEO optical MoE."""
...
class DeepHeterogeneousOpticalMoENonlinearClassifier(nn.Module):
    def __init__(self, config, num_classes=4):
        ...
        # Every expert's Stage5 already contains the configured 5 cm
        # phase-to-OEO propagation.  Its re-encoded output is therefore at the
        # shared global-phase plane; adding the old linear experiment's extra
        # expert_to_global_fc propagator here would silently create a sixth
        # free-space segment.
    ...
    def nonlinearity_parameter_count(self):
        return self.expert_bank.nonlinearity_parameter_report()["trainable_parameters"]
    ...
    def electronic_parameter_count(self):
        return self.router_parameter_count() + self.nonlinearity_parameter_count()
