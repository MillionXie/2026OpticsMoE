"""CIFAR-10 heterogeneous nine-expert linear optical MoE."""
...
class HeterogeneousOpticalMoEClassifier(nn.Module):
    def __init__(self, config, num_classes=4):
        ...
        self.expert_bank = HeterogeneousExpertBank(self.layout, config.get("experts", {}), optics)
