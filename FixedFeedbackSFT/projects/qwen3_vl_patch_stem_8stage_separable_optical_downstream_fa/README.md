...
```text
FixedFeedbackSFT/runs/qwen3_vl_patch_stem_8stage_separable_optical_downstream_fa/
  p12_downstream_fa_50e/<task>/<method>/seed_<seed>/
```
...
```text
FixedFeedbackSFT/runs/qwen3_vl_patch_stem_8stage_separable_optical_downstream_fa/
  p12_downstream_fa_50e/<task>/common/seed_<seed>/common_start.pt
```
