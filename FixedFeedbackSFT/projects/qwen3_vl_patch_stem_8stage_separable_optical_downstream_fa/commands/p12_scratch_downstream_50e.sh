...
RUNS_DIR="${P12_SCRATCH_RUNS_ROOT:-${REPO_ROOT}/FixedFeedbackSFT/runs/qwen3_vl_patch_stem_8stage_separable_optical_downstream_fa}"
...
RUN_ROOT="${P12_SCRATCH_RUN_ROOT:-${RUNS_DIR}/p12_scratch_p11_body_seed_${INIT_SEED}_50e}"
SOURCE_CHECKPOINT="${P12_SCRATCH_SOURCE:-${RUNS_DIR}/p12_scratch_sources/p11_body_seed_${INIT_SEED}/backbone.pt}"
