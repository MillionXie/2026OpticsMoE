...
p08 = Path("FixedFeedbackSFT/runs/qwen3_vl_patch_stem_8stage_optical_imagenet_backbone/p08_imagenet1k_pretrain_bs96_90e/metrics/history.json")
p09 = Path("FixedFeedbackSFT/runs/qwen3_vl_patch_stem_8stage_slim_mixer_imagenet_backbone/p09_imagenet1k_pretrain_bs96_90e/metrics/history.json")
