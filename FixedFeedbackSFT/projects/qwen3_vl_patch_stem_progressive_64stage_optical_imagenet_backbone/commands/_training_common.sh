...
FORMAL_STEM_CHECKPOINT="FixedFeedbackSFT/projects/qwen3_vl_patch_stem_8stage_optical_imagenet_backbone/assets/qwen3_vl_static_stem_224.pt"
FORMAL_P11_BACKBONE_CHECKPOINT="${P11_RUNS_DIR}/p11_imagenet1k_pretrain_bs96_90e/checkpoints/backbone.pt"
FORMAL_P11_TRAINING_CHECKPOINT="${P11_RUNS_DIR}/p11_imagenet1k_pretrain_bs96_90e/checkpoints/best.pt"
