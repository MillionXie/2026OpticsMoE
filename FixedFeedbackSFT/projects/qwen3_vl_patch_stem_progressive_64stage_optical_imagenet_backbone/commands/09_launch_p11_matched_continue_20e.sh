...
RUN_DIR="${RUNS_DIR}/p11_epoch88_matched_continue_20e_gb192"
BASE_LOG="${RUNS_DIR}/logs/p11_epoch88_matched_continue_20e_gb192.log"
LATEST_LOG="${RUNS_DIR}/logs/p11_epoch88_matched_continue_20e_gb192.latest.log"
...
nohup "${PYTHON_BIN}" -m "${MODULE}.p11_matched_continue" \
  --config "${CONFIG}" "${MODE}" \
