...
FORMAL_TRAINING_IMPLEMENTATION_FILES = (
    ...
    "FixedFeedbackSFT/projects/qwen3_vl_patch_stem_progressive_64stage_optical_imagenet_backbone/model.py",
    "FixedFeedbackSFT/projects/qwen3_vl_patch_stem_progressive_64stage_optical_imagenet_backbone/migration.py",
