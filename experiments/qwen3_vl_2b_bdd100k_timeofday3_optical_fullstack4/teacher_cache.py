...
CACHED_TENSORS = [
    "sample_indices", "labels", "image_grid_thw", "visual_token_counts",
...
def expected_metadata(split: str, samples: int, settings: Any, model: nn.Module, class_names: Sequence[str]) -> dict[str, Any]:
    return {
        ...
        "dataset": "bdd100k_timeofday3", "data_root": str(settings.data_root), "class_names": list(class_names),
        ...
        "prompt": settings.classification_prompt, "processor_min_pixels": settings.processor_min_pixels,
        ...
        "replacement_mode": "vision_and_language_fullstack4", "cached_tensors": list(CACHED_TENSORS),
    }
