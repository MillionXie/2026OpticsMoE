...
class DeepStackMultimodalReplacement:
    ...
    def _capture_language(self, _module: nn.Module, _args: tuple[Any, ...], output: Any) -> None:
        ...
        self.last_language_hidden = value; setattr(self.model, "_spaq_optical_last_hidden", value)
    ...
    def close(self) -> None:
        ...
        if hasattr(self.model, "_spaq_optical_last_hidden"): delattr(self.model, "_spaq_optical_last_hidden")
