...
class Settings:
    ...
    experiment_name: str = "qwen3_vl_2b_spaq_single_attribute_multimodal_homogeneous_moe9"
    ...
    output_dir: Path = PROJECT_DIR / "runs" / "qwen3_vl_2b_spaq_mos_vision_language_homogeneous_moe9"
