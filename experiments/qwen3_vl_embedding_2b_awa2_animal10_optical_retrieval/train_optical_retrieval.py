...
def select_gallery_items_for_queries(
    ...
    query_samples: Sequence[AwA2Sample],
) -> list[dict[str, Any]]:
...
def train_optical_retrieval(
    ...
    *,
    ...
    train_dataset = AwA2RetrievalDataset(
    ...
    gallery_dataset = AwA2RetrievalDataset(
    ...
    for epoch in range(start_epoch, end_epoch + 1):
        ...
        if (
            ...
            save_phase_preview(
                ...
                title=(
                    f"AwA2 optical phase epoch {epoch} "
...
def evaluate_student_split(
    ...
    readout: OpticalRetrievalReadout,
    query_samples: Sequence[AwA2Sample],
    gallery_samples: Sequence[AwA2Sample],
