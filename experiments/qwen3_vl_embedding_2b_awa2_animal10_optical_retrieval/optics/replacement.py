...
class DeepStackMultimodalReplacement:
    ...
    def _capture_language(
        ...
        setattr(self.model, "_awa2_retrieval_optical_last_hidden", value)
    ...
    def close(self) -> None:
        ...
        for handle in self._handles:
            handle.remove()
        if hasattr(self.model, "_awa2_retrieval_optical_last_hidden"):
            delattr(self.model, "_awa2_retrieval_optical_last_hidden")
