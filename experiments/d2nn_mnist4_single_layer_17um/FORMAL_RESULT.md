...
normal-polarity hardware ZIP:
7067f1bd9cf0d4fe3cee0bc3f857007a0b24fd04fa65396cd8cc9923ef63673c
```
...
修正后的硬件极性直接编码为 `255=白/透光`、`0=黑/遮光`，不再黑白反相。相位BMP
SHA-256与旧导出完全一致，说明本次只改变振幅编码，没有改动训练得到的相位mask。
