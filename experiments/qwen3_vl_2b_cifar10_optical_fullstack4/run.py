...
def build_parser() -> argparse.ArgumentParser:
    parser=argparse.ArgumentParser(description="Qwen3-VL-2B CIFAR-10 full vision+language optical4 distillation")
...
def _compare(settings:Settings,names:list[str])->None:
    ...
    comparison={"dataset":"cifar10","classes":names,"replacement":"both_full_stacks_optical4","teacher":teacher,"student":student,"accuracy_drop":{"top1":teacher["top1_accuracy"]-student["top1_accuracy"],"top5":teacher["top5_accuracy"]-student["top5_accuracy"]}}
