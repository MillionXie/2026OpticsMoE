...
class Settings:
    dataset: str = "cifar10"
    data_root: Path = PROJECT_DIR / "data" / "cifar10"
    download: bool = True
    output_dir: Path = PROJECT_DIR / "runs" / "qwen3_vl_2b_cifar10_optical_fullstack4"
    ...
    classification_prompt: str = (
        "Classify this image into one of the following CIFAR-10 classes: airplane, automobile, "
        "bird, cat, deer, dog, frog, horse, ship, truck. Answer:"
    )
