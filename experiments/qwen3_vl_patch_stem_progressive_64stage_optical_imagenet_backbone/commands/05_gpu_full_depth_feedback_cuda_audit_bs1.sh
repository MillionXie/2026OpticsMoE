...
export OUTPUT_DIRECTORY="${OUTPUT_DIRECTORY:-experiments/qwen3_vl_patch_stem_progressive_64stage_optical_imagenet_backbone/runs/p13_full_depth_feedback_cuda_audit_bs1}"
