...
select_progressive_growth_stage() {
  ...
  PARENT_CHECKPOINT="${EXPERIMENT}/runs/${PARENT_RUN_NAME}/checkpoints/best_full_depth.pt"
  TARGET_RUN_DIR="${EXPERIMENT}/runs/${TARGET_RUN_NAME}"
  TARGET_CONFIG="${EXPERIMENT}/configs/generated/${TARGET_RUN_NAME}.yaml"
  TARGET_BASE_LOG="${EXPERIMENT}/logs/${TARGET_RUN_NAME}.log"
  TARGET_LATEST_LOG="${EXPERIMENT}/logs/${TARGET_RUN_NAME}.latest.log"
