...
class DeepStackMultimodalReplacement:
    ...
    def _capture_language(
        ...
        setattr(self.model, "_kadid_electronic_router_optical_last_hidden", value)
    ...
    def close(self) -> None:
        ...
        for handle in self._handles:
            handle.remove()
        if hasattr(self.model, "_kadid_electronic_router_optical_last_hidden"):
            delattr(self.model, "_kadid_electronic_router_optical_last_hidden")
