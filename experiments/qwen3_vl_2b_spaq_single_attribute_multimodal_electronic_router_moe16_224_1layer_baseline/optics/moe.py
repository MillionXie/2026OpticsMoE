...
class HomogeneousMoEOpticalCore(nn.Module):
    ...
    def __init__(self, hidden_size: int, max_tokens: int, settings: Any) -> None:
        ...
        # The expert-to-reload/global-plane hop and global-to-CCD hop are both
        # fixed at 10 cm in this baseline. Reuse one immutable transfer
        # function instead of storing duplicate 1026x1026 complex buffers.
...
class LanguageDeepStackHomogeneousMoE(nn.Module):
    ...
    def set_deepstack_injection_count(self, count: int) -> None:
        ...
        # optical-stage bound as it was in the multi-stage implementation.
