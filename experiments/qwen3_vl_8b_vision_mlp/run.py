...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Qwen3-VL-8B vision-only frozen feature + MLP classifier"
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.phase in {"all", "extract", "inference"}:
        ...
        model_record["feature_path"] = "vision_only_get_image_features"
    ...
    if args.phase in {"all", "train"}:
        ...
        if loaded is not None:
            ...
            report["feature_path"] = "vision_only_get_image_features"
    ...
    if args.phase in {"all", "inference"}:
        ...
        summary = {
            ...
            "model_id": settings.model_id,
            "feature_path": "vision_only_get_image_features",
