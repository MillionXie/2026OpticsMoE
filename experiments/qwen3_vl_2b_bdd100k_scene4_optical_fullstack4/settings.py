...
@dataclass
class Settings:
    dataset: str = "bdd100k_scene4"
    data_root: Path = PROJECT_DIR / "data" / "bdd100k_scene4"
    download: bool = True
    imagefolder_train: str = "train"
    imagefolder_test: str = "test"
    output_dir: Path = PROJECT_DIR / "runs" / "qwen3_vl_2b_bdd100k_scene4_optical_fullstack4"
    ...
    classification_prompt: str = (
        "Classify this driving scene into one of the following scene categories: "
        "highway, city street, residential, other. Answer:"
    )
    ...
    def validate(self) -> None:
        if self.dataset != "bdd100k_scene4":
            raise ValueError("This experiment requires dataset='bdd100k_scene4'")
