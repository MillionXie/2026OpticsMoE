...
from . import MODEL_ID, SUPPORTED_TASKS
...
class Settings:
    ...
    experiment_name: str = "qwen3_vl_2b_spaq_single_attribute_vision_homogeneous_moe9"
    dataset: str = "spaq_single_attribute"
    task_name: str = "Brightness"
    ...
    output_dir: Path = PROJECT_DIR / "runs" / "qwen3_vl_2b_spaq_brightness_vision_homogeneous_moe9"
