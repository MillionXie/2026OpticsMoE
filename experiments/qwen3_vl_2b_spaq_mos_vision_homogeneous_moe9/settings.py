...
from . import MODEL_ID, TASK_NAME


PROJECT_DIR = Path(__file__).resolve().parent
PATH_FIELDS = {"data_root", "annotations_file", "image_dir", "output_dir", "cache_dir"}
...
class Settings:
    ...
    experiment_name: str = "qwen3_vl_2b_spaq_mos_vision_homogeneous_moe9"
    ...
    output_dir: Path = PROJECT_DIR / "runs" / "qwen3_vl_2b_spaq_mos_vision_homogeneous_moe9"
    ...
    def validate(self) -> None:
        ...
        if self.dataset != "spaq_mos" or self.task_name != TASK_NAME:
            raise ValueError("This experiment requires dataset='spaq_mos' and task_name='MOS'")
        ...
        for name in ("loss_hidden_weight", "loss_prediction_distill_weight", "loss_regression_weight",
