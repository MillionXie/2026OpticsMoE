...
from experiments.qwen3_vl_8b_multimodal_mlp.io_utils import write_json
from experiments.qwen3_vl_8b_multimodal_mlp.modeling import MLPHead
from experiments.qwen3_vl_8b_multimodal_mlp.training import train_head
from experiments.qwen3_vl_8b_multimodal_mlp.visualize import generate_figures
        ...
        "timing": {
            "components": {
                ...
                for name, value in {
                    ...
                    "multimodal_preprocess_sec": 0.2,
                    "host_to_device_sec": 0.1,
                    "multimodal_forward_sec": 2.0,
                    "hidden_pooling_sec": 0.1,
                    "mlp_forward_sec": 0.1,
                    "postprocess_sec": 0.1,
                }.items()
            }
