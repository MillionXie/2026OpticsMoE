...
| 专家 | x 区间 | y 区间 | 区域大小 |
|---|---:|---:|---:|
| 0，左上 | `[162,221)` | `[162,221)` | 59×59 |
| 1，右上 | `[257,316)` | `[162,221)` | 59×59 |
| 2，左下 | `[162,221)` | `[257,316)` | 59×59 |
| 3，右下 | `[257,316)` | `[257,316)` | 59×59 |

这是当前 10 cm MNIST4 angle-ROI 使用的映射。四区顺序与 MoE4 专家的行优先顺序
完全一致。
