...
$source = Join-Path $root "vendor_sdk\camera_dvp_legacy\lib\windows\python3.6\x64"
...
Copy-Item -Force (Join-Path $PSScriptRoot "dvp_capture_worker.py") (Join-Path $runtime "dvp_capture_worker.py")
