...
dataHeight = slm.height_px  # Can be set to 1 to have a faster calculation and less video memory in case of vertical blazed gratings.
...
for blazePeriod in gratingPeriodList:
    ...
    if slmdisplaysdk.supportNumPy:
        ...
        for x in range(dataWidth):
            ...
            row[0, x] = float(phaseModulation * (x - dataWidth / 2.0) / blazePeriod + phaseModulation * 0.5 / 256.0)
