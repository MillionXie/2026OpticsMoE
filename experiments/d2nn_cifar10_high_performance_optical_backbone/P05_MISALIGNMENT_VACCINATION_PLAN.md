...
到 epoch 2，七环境平均相对 source 提高 9.69 pp，理想性能下降 2.66 pp，尚处预先声明的 3 pp 容忍线内。所有六个错位环境均相对 source 改善；当前最弱项仍是 layerwise 1 pixel。训练已进入 epoch 3，并继续按既定课程扩到 2 pixel，不能用以上中途结果替代 validation-best 最终汇总。
