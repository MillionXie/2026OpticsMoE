...
F3B提交`1379a525`同步后在物理GPU 4启动，launcher/main PID为1687555/1687570，watcher
PID为1690859。manifest实测相位、残差电子、预训练头分别为1,204,224/312,336/1,440,488，
残差与两个解耦读出合计1,752,824，满足2M约束。兼容加载保留全部8x224 encoder、1536维
