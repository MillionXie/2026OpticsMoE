...
RUN_DIR="experiments/d2nn_cifar10_high_performance_optical_backbone/runs/p06_imagenet_100k_screen"
mkdir -p "${RUN_DIR}"
...
nohup env PHYSICAL_GPU_INDICES="${PHYSICAL_GPU_INDICES}" \
  bash experiments/d2nn_cifar10_high_performance_optical_backbone/commands/52_run_p06_imagenet_100k_screen.sh \
