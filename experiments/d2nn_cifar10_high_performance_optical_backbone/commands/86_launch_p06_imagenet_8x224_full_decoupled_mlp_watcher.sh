...
RUN_DIR="experiments/d2nn_cifar10_high_performance_optical_backbone/runs/p06_imagenet_8x224_full_decoupled_mlp"
mkdir -p "${RUN_DIR}"
...
nohup env PHYSICAL_GPU_INDEX="${PHYSICAL_GPU_INDEX:-4}" \
  bash experiments/d2nn_cifar10_high_performance_optical_backbone/commands/85_watch_p06_imagenet_8x224_full_decoupled_mlp.sh \
