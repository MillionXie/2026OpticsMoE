...
RUN_DIR="experiments/d2nn_cifar10_high_performance_optical_backbone/runs/p06_imagenet_8x224_screen_spatial"
...
nohup env SCREEN_VARIANT=spatial PHYSICAL_GPU_INDEX="${PHYSICAL_GPU_INDEX}" \
  bash experiments/d2nn_cifar10_high_performance_optical_backbone/commands/74_run_p06_imagenet_8x224_screen.sh \
