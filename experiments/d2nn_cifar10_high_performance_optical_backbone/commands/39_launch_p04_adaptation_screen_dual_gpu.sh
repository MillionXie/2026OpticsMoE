...
nohup bash experiments/d2nn_cifar10_high_performance_optical_backbone/commands/37_run_p04_adaptation_screen.sh \
  > experiments/d2nn_cifar10_high_performance_optical_backbone/logs/p04_global_gpu4.log 2>&1 &
global_pid=$!

PHYSICAL_GPU_INDEX=5 \
CONDITIONS_CSV=layerwise_shift_0p125px,layerwise_shift_0p25px \
nohup bash experiments/d2nn_cifar10_high_performance_optical_backbone/commands/37_run_p04_adaptation_screen.sh \
  > experiments/d2nn_cifar10_high_performance_optical_backbone/logs/p04_layerwise_gpu5.log 2>&1 &
layerwise_pid=$!
