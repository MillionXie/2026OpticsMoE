...
RUN_DIR="experiments/d2nn_cifar10_high_performance_optical_backbone/runs/p06_imagenet_full_mlp_readout"
mkdir -p "${RUN_DIR}"
...
nohup env PHYSICAL_GPU_INDEX="${PHYSICAL_GPU_INDEX}" \
  bash experiments/d2nn_cifar10_high_performance_optical_backbone/commands/64_run_p06_imagenet_full_mlp_readout.sh \
