...
vaccinated_checkpoint="experiments/d2nn_cifar10_high_performance_optical_backbone/runs/p05_misalignment_vaccination/seed_2026/best.pt"
: "${GLOBAL_GPU_INDEX:=3}"
...
nohup bash experiments/d2nn_cifar10_high_performance_optical_backbone/commands/46_run_p05b_vaccinated_adaptation.sh \
  > experiments/d2nn_cifar10_high_performance_optical_backbone/logs/p05b_global_gpu${GLOBAL_GPU_INDEX}.log 2>&1 &
global_pid=$!

PHYSICAL_GPU_INDEX="${LAYERWISE_GPU_INDEX}" \
CONDITIONS_CSV=heldout_layerwise_shift_1px,heldout_layerwise_shift_2px \
nohup bash experiments/d2nn_cifar10_high_performance_optical_backbone/commands/46_run_p05b_vaccinated_adaptation.sh \
  > experiments/d2nn_cifar10_high_performance_optical_backbone/logs/p05b_layerwise_gpu${LAYERWISE_GPU_INDEX}.log 2>&1 &
layerwise_pid=$!
