...
EXPERIMENT="experiments/qwen3_vl_patch_stem_8stage_dual_scale_optical_imagenet_backbone"
P09_EXPERIMENT="experiments/qwen3_vl_patch_stem_8stage_optical_imagenet_backbone"
