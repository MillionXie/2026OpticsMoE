...
class HomogeneousMoEOpticalCore(nn.Module):
    ...
    def router_hard_load_balance_loss(self) -> torch.Tensor:
        return self.last_routing["hard_load_balance_loss"]

    def update_router_load_bias(self, update_rate: float) -> None:
        self.router.update_load_bias(self.last_routing["selected_mask"], update_rate)
...
class VisionDeepStackHomogeneousMoE(nn.Module):
    ...
    def router_hard_load_balance_loss(self): return self.core.router_hard_load_balance_loss()
    def update_router_load_bias(self, update_rate: float): self.core.update_router_load_bias(update_rate)
