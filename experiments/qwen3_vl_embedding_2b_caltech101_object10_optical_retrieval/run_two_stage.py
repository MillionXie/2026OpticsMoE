"""Run the reproducible Caltech101 all-101 pretrain -> target-10 adaptation route."""
...
def main() -> int:
    ...
    stage1_config = experiment / "configs" / "caltech101_101class_pretrain.yaml"
    stage2_config = experiment / "configs" / "caltech101_10class_finetune.yaml"
    stage1_output = experiment / "runs" / "caltech101_101class_pretrain"
    stage2_output = experiment / "runs" / "caltech101_10class_finetune_epoch50"
