...
from .prepare_caltech101_retrieval_subset import prepare_caltech101_subset
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Qwen3-VL-Embedding-2B -> Optical Student Caltech101 retrieval"
    )
    ...
    # or touch the extracted dataset for this phase.
