...
```bash
CUDA_VISIBLE_DEVICES=0 python -m experiments.qwen3_vl_2b_spaq_multitask_iqa --config experiments/qwen3_vl_2b_spaq_multitask_iqa/configs/spaq.json --phase all
```
