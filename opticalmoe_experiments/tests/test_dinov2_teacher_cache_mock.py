...
def _training_config(cache_dir):
    return {
        ...
        "classifier": {"input": "semantic_feature", "input_dim": "auto_teacher_dim", "hidden_dim": 8, "hidden_layers": 1},
        "projector": {"type": "mlp", "input_dim": "auto_feature_dim", "output_dim": "auto_teacher_dim", "hidden_dim": 8, "hidden_layers": 1, "output_l2_normalize": True},
