...
class FourLayerOpticalReplacement(ElectronicDeepStackReplacement):
    ...
    training_architecture_label = "vision2_language2_moe4_joint_dual_fusion"
    checkpoint_architecture = "vision2_language2_moe4_joint_dual_fusion_v1"
    ...
    def student_architecture_report(self) -> dict[str, Any]:
        ...
        return {
            ...
            "vision": {
                ...
                "fusion": "two independent learned sigmoid gates",
            },
            "language": {
