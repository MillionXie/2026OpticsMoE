...
EXPECTED_FRESNEL_V4_MANIFEST_SHA256 = (
...
LAB_RUNTIME_FILES = (
    ...
    "experiments/hardware_sdk/generators/slm_patterns/V4_CALIBRATION_COMMANDS.md",
...
def validate_fresnel_v3(directory: str | Path) -> dict[str, Any]:
    ...
    if manifest_sha256 != EXPECTED_FRESNEL_V4_MANIFEST_SHA256:
        raise RuntimeError(
            "Fresnel v3 manifest is stale or unreviewed: expected the center-preserving "
            f"release {EXPECTED_FRESNEL_V4_MANIFEST_SHA256}, got {manifest_sha256}"
        )
    required_scalar = {
        "schema_version": 3,
        "wavelength_nm": 532.0,
