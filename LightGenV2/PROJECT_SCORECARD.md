...
| P2 | **T07 商品检索（图搜图）** | ABO similarity10；商品train/val/test=120/40/40；新增922商品仅训练；480查询×原120商品中心；同类为相关；单seed周期test选模 | Hit@1/5/10、Precision、positive Recall、mAP@10、NDCG@10↑ | **严格α>0.4、光Router Top2：Hit@1 75.2083%、mAP@10 0.71290（4090）**；同best去光60.2083% | — | — | Frozen Qwen native2048D **Hit@1 95.2083%**，mAP@10 **0.83253**；旧光学输入64D **92.9167%** | 本轮未测 | 本轮未测 | — | **domain_mixed_20260911完成**，source09835251，第15轮live；α0.428–0.440；干净训练99.7222%，泛化差距仍大。原数据对照70.4167%，外部适配再混合72.5%；正在准备扩大池/同商品多视角对照，原评估集不变。[任务与证据](tasks/t07_abo_image_retrieval/README.md) |
