...
| P2 | **T07 商品检索（图搜图）** | ABO enrolled200；固定200已登记SKU，每商品8张TRAIN/gallery+4张QUERY，共1600/800；同SKU为相关；周期TEST、EMA及跨run选模 | Hit@1/5/10、mAP@10、NDCG@10↑ | **光Top2、α>.4：Hit@1 83.125%（665/800）、mAP@10 .73039534、NDCG@10 .78805760**；同best去光76.375% | — | 本协议未测 | 冻结Qwen Embedding首64D、L2、零训练：**85.125%（681/800）**；差距2.000pp | 本协议未测 | 本协议未测 | — | **两次独立原图确认665/800。**run abo200_readout_within_sku_verified_20260915；从原83%做TRAIN同SKU协方差2%收缩，折叠原Linear W/b。原六次10cm、光Top2、相位/ROI/电子主干/α全部不变，无新层/参数/TF/attention。TRAIN94.625%，差距11.5pp；去光下降6.75pp；α .4449–.4477，TEST V/L为6/5组合、分split路由合格。同环境旧权重仍664/800，配对1张错变对/0张对变错；仅净增1张、不宣称显著或硬件达标。best c9926cba…894192d0，源码67566b88，463测试；原图报告63f8ce8d…2a4fe432。旧83权重保留，GPU已释放。旧480查询类别协议不可混用。[复现与证据](tasks/t07_abo_image_retrieval/reports/reproduction/README.md) |
