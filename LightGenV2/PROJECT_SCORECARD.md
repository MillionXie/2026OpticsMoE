...
| P2 | **T07 商品检索（图搜图）** | ABO similarity10；商品train/val/test=120/40/40；480查询×120训练商品中心；同类为相关；单seed周期test选模 | Hit@1/5/10、Precision、positive Recall、mAP@10、NDCG@10↑ | **光Router Top-2相位再加热：Hit@1 70.0000%、mAP@10 0.67951（A100）**；同best去光67.0833% | — | — | 本轮Frozen Qwen native2048D **Hit@1 95.2083%**，mAP@10 **0.83253**；同光学输入64D **92.9167%** | 本轮未测 | 本轮未测 | — | **三组30epoch续训及固定复评完成。**best=polish_phase_reheat_20260910/epoch10；4090两次复评70.2083%，跨GPU差1张，主表保守记70.00%；alpha约0.087–0.104，去光降2.9167个百分点。仍明显落后baseline。[任务与证据](tasks/t07_abo_image_retrieval/README.md) |
