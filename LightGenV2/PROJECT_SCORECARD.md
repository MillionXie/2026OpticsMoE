...
| P2 | **T07 商品检索（图搜图）** | ABO similarity10；商品train/val/test=120/40/40；新增2058商品仅训练；480查询×原120商品中心；同类为相关；单seed周期test选模 | Hit@1/5/10、Precision、positive Recall、mAP@10、NDCG@10↑ | **严格α>0.4、光Router Top2：Hit@1 76.25%、mAP@10 0.73225（3090）**；同best去光60.625% | — | — | Frozen Qwen native2048D **Hit@1 95.2083%**；native64D **94.375%**（20260912复评，0训练参数） | 本轮未测 | 本轮未测 | — | **domain_refine_wide_20260912_gpu2完成**，sourceac737d41，第16轮EMA；α0.428–0.440；干净训练100%，81%目标未达。去光下降15.625个百分点，仍在做蒸馏、扩训练池及小型电子卷积对照；测试/图库不改。[任务与证据](tasks/t07_abo_image_retrieval/README.md) |
