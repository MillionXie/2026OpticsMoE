...
| P2 | **T07 商品检索（图搜图）** | ABO enrolled200；固定200已登记SKU，每商品8张TRAIN/gallery+4张QUERY，共1600/800；同SKU为相关；单seed周期TEST及跨run选模 | Hit@1/5/10、mAP@10、NDCG@10↑ | **光Top2、α>.4：Hit@1 82.50%（660/800）、mAP@10 .73045914、NDCG@10 .78730255**；同best去光75.875% | — | 本协议未测 | 冻结Qwen Embedding首64D、L2、零训练：**85.125%（681/800）**；差距2.625pp | 本协议未测 | 本协议未测 | — | **当前候选原图4090复评完成，83%目标尚差4张。**原384→64头TRAIN-only Top1排序损失、dropout=.1与弱锚定，不增层/参数；TRAIN95.00%、α .4449–.4477；去光下降6.625pp。Hit同分按mAP选取，83%未达标。TEST侧V/L为6/5种Top2组合，图库/查询分别路由合格。六次10cm/ROI及光学权重不变。best SHA 10925d29…8bb01b26，源码737f9303，verification报告d1635300…b8cbc5db。旧GPU4再加热完成82.125%，读出校准并列82.50%，GPU5双向组10轮主动停止；均已释放。2026-09-15新相位+原头12轮训练运行于GPU0/PID1772832，冻结其余电子，源码ff5b44e3、403测试与GPU冒烟通过，暂无新成绩。旧480查询类别协议不可混用。[复现与证据](tasks/t07_abo_image_retrieval/reports/reproduction/README.md) |
