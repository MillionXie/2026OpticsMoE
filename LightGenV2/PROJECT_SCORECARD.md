...
| P2 | **T07 商品检索（图搜图）** | ABO similarity10；商品train/val/test=120/40/40；480查询×120训练商品中心；同类为相关；单seed周期test选模 | Hit@1/5/10、Precision、positive Recall、mAP@10、NDCG@10↑ | **光Router Top-2训练优化：Hit@1 69.5833%、mAP@10 0.67617**；同best去光67.0833%；电子增强组67.0833% | — | — | 本轮Frozen Qwen native2048D **Hit@1 95.2083%**，mAP@10 **0.83253**；同光学输入64D **92.9167%** | 本轮未测 | 本轮未测 | — | **两组80epoch续训完成，仍明显落后baseline。**best=refine_training_20260909/epoch80，六次传播；alpha约0.088–0.104，去光降2.50个百分点。继续尝试训练图库对齐和关系蒸馏。[任务与证据](tasks/t07_abo_image_retrieval/README.md) |
