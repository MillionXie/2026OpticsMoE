...
| P2 | **T07 商品检索（图搜图）** | ABO similarity10；商品train/val/test=120/40/40；480查询×120训练商品中心；同类为相关 | Hit@1/5/10、Precision、positive Recall、mAP@10、NDCG@10↑ | 40epoch光Router Top-2训练中，尚无正式成绩 | — | — | 本轮Frozen Qwen native2048D **Hit@1 95.2083%**，mAP@10 **0.83253**；同光学输入64D **92.9167%** | 本轮未测 | 本轮未测 | — | **冻结baseline复现完成，光学小检查通过并已启动正式训练。**V/L各Router+专家+全局，电子残差同尺度融合；不与T08混用。[本轮证据](tasks/t07_abo_image_retrieval/reports/reproduction/RUN_20260909.md) |
