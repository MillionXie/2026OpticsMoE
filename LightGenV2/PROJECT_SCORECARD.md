...
| P2 | **T07 商品检索（图搜图）** | ABO similarity10；商品train/val/test=120/40/40；新增2058商品仅训练；480查询×原120商品中心；同类为相关；单seed周期test选模 | Hit@1/5/10、Precision、positive Recall、mAP@10、NDCG@10↑ | **严格α>0.4、光Router Top2：Hit@1 79.375%、mAP@10 0.76232523（4090）**；同best去光62.9167% | — | — | Frozen Qwen native2048D **Hit@1 95.2083%**；native64D **94.375%**（20260912复评，0训练参数） | 本轮未测 | 本轮未测 | — | **verify_joint_ep8_20260912_gpu1/evaluation固定权重复评完成**，第8轮live训练9e0d9544、复评f695014b；381/480，α0.428–0.440；干净训练99.9306%，81%目标未达。去光下降16.4583个百分点；教师仅训练，仍原线性头/光路，无TF/attention。只比前版多3个命中，不宣称显著；完整16轮仍在继续。[任务与证据](tasks/t07_abo_image_retrieval/README.md) |
