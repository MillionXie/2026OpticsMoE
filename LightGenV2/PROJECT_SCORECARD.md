...
| P2 | **T07 商品检索（图搜图）** | ABO similarity10；商品train/val/test=120/40/40；新增2058商品仅训练；480查询×原120商品中心；同类为相关；单seed周期test选模 | Hit@1/5/10、Precision、positive Recall、mAP@10、NDCG@10↑ | **严格α>0.4、光Router Top2：Hit@1 77.50%、mAP@10 0.7266903（4090）**；同best去光59.375% | — | — | Frozen Qwen native2048D **Hit@1 95.2083%**；native64D **94.375%**（20260912复评，0训练参数） | 本轮未测 | 本轮未测 | — | **verify_strong_ep4_20260912_gpu1固定权重复评完成**，训练source6ab405fe第4轮live，复评5f3c704a；α0.428–0.439；干净训练99.8611%，81%目标未达。去光下降18.125个百分点；训练仍在进行，教师只用于训练，无新增TF/attention；测试/图库不改。[任务与证据](tasks/t07_abo_image_retrieval/README.md) |
