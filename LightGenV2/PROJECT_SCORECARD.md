...
| P2 | **T07 商品检索（图搜图）** | ABO similarity10；商品train/val/test=120/40/40；480查询×120训练商品中心；同类为相关；单seed周期test选模 | Hit@1/5/10、Precision、positive Recall、mAP@10、NDCG@10↑ | **严格α>0.4、光Router Top2：Hit@1 69.7917%、mAP@10 0.68242（4090）**；同best去光57.2917% | — | — | Frozen Qwen native2048D **Hit@1 95.2083%**，mAP@10 **0.83253**；旧光学输入64D **92.9167%** | 本轮未测 | 本轮未测 | — | **generalization_20260911/preserve_adam完成**，epoch25 live；完整输入，α0.429–0.440。较旧高α仅多4张命中；干净训练99.9306%，泛化差距仍大。新增强/相位dropout对照排队。旧低α70.21%不混入约束版。[任务与证据](tasks/t07_abo_image_retrieval/README.md) |
