...
| P2 | **T07 商品检索（图搜图）** | ABO similarity10；商品train/val/test=120/40/40；480查询×120训练商品中心；同类为相关；单seed周期test选模 | Hit@1/5/10、Precision、positive Recall、mAP@10、NDCG@10↑ | **光Router Top-2加强语义训练：Hit@1 65.4167%、mAP@10 0.58556**；初版60.8333%；同best去光64.5833% | — | — | 本轮Frozen Qwen native2048D **Hit@1 95.2083%**，mAP@10 **0.83253**；同光学输入64D **92.9167%** | 本轮未测 | 本轮未测 | — | **两组40epoch及baseline完成，但光学性能仍有明显差距。**V/L各Router+专家+全局，alpha约0.10；语言有固定首选专家，去光仅降0.83个百分点，不能称强光学贡献。[本轮证据](tasks/t07_abo_image_retrieval/reports/reproduction/RUN_20260909.md) |
