...
| P2 | **T07 商品检索（图搜图）** | ABO similarity10；商品train/val/test=120/40/40；480查询×120训练商品中心；同类为相关；单seed周期test选模 | Hit@1/5/10、Precision、positive Recall、mAP@10、NDCG@10↑ | **严格α>0.4、光Router Top2：Hit@1 68.9583%、mAP@10 0.67571（4090）**；同best去光64.5833% | — | — | Frozen Qwen native2048D **Hit@1 95.2083%**，mAP@10 **0.83253**；同光学输入64D **92.9167%** | 本轮未测 | 本轮未测 | — | **high_alpha_retrieval_20260910完成**，epoch15 EMA；α0.430–0.440，去光降4.375个百分点。独立代码1920条特征逐位复评一致。旧低α70.00%（A100）/70.2083%（4090）仅作历史，不混入约束版。[任务与证据](tasks/t07_abo_image_retrieval/README.md) |
