...
| P2 | **T07 商品检索（图搜图）** | ABO enrolled200；固定200已登记SKU，每商品8张TRAIN/gallery+4张QUERY，共1600/800；同SKU为相关；单seed周期TEST及跨run选模 | Hit@1/5/10、mAP@10、NDCG@10↑ | **光Top2、α>.4：Hit@1 81.25%（650/800）、mAP@10 .72003057、NDCG@10 .77885835**；同best去光75.875% | — | 本协议未测 | 冻结Qwen Embedding首64D、L2、零训练：**85.125%（681/800）**；差距3.875pp | 本协议未测 | 本协议未测 | — | **仿真训练与固定best独立复评完成；非硬件结果。**外部453-SKU相位优先预训练→目标联合微调，最佳epoch41/目标5 EMA；TRAIN93.875%、α .4449–.4477；同权重去光下降5.375pp。TEST侧V/L分别6/5种Top2组合，无阈值定义的坍缩。无新增TF/attention或电子容量，原六次10cm/ROI不变。best SHA dcf76887…197eb1d，训练cf32e929、复评2ee704e1；GPU已释放。旧480查询类别检索协议与本行不可混用。[复现与证据](tasks/t07_abo_image_retrieval/reports/reproduction/README.md) |
