...
| P2 | **T07 商品检索（图搜图）** | ABO enrolled200；固定200已登记SKU，每商品8张TRAIN/gallery+4张QUERY，共1600/800；同SKU为相关；单seed周期TEST及跨run选模 | Hit@1/5/10、mAP@10、NDCG@10↑ | **光Top2、α>.4：Hit@1 81.875%（655/800）、mAP@10 .72648332、NDCG@10 .78354960**；同best去光75.50% | — | 本协议未测 | 冻结Qwen Embedding首64D、L2、零训练：**85.125%（681/800）**；差距3.25pp | 本协议未测 | 本协议未测 | — | **当前候选原图4090复评完成，83%目标尚未达到。**光优先81.25%起点后仅校准并合并原线性head，不增层/参数；TRAIN94.6875%、α .4449–.4477；去光下降6.375pp。TEST侧V/L为6/5种Top2组合，分开路由合格。原六次10cm/ROI及所有光学权重不变。best SHA a5794137…9aeb482，源码a4ff9ebb，verification_4090报告e434d4b5…b0a0756；复评进程释放，另两组GPU续训仍运行。旧480查询类别协议不可混用。[复现与证据](tasks/t07_abo_image_retrieval/reports/reproduction/README.md) |
