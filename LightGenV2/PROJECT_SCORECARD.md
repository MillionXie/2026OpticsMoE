...
| P2 | **T07 商品检索（图搜图）** | ABO enrolled200；固定200已登记SKU，每商品8张TRAIN/gallery+4张QUERY，共1600/800；同SKU为相关；周期TEST、EMA及跨run选模 | Hit@1/5/10、mAP@10、NDCG@10↑ | **光Top2、α>.4：Hit@1 83.00%（664/800）、mAP@10 .72972315、NDCG@10 .78731877**；同best去光76.375% | — | 本协议未测 | 冻结Qwen Embedding首64D、L2、零训练：**85.125%（681/800）**；差距2.125pp | 本协议未测 | 本协议未测 | — | **83%已独立原图4090复评。**run abo200_phase_head_top1_verified_20260915；从82.75%起点仅2步TRAIN相位+原头Top1训练，EMA获选，非完整8轮。仅12份相位与原Linear变化，冻结全部其他电子/α；原六次10cm、Top2、ROI、64D、无TF/attention不变。TRAIN94.875%，差距11.875pp；去光下降6.625pp，α .4449–.4477。分split专家门槛通过，TEST V/L为6/5组合。相位改变量约2e-6 rad；比82.75%只多2张，不宣称显著或硬件达标。best SHA 538477e0…bf0b27b2，源码d111dd91，410测试；独立报告8fd14ece…76b7c8ec。旧12轮NLL组完成82.50%未采用；所有自有训练/复评GPU已释放。旧480查询类别协议不可混用。[复现与证据](tasks/t07_abo_image_retrieval/reports/reproduction/README.md) |
