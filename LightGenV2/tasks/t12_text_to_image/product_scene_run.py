"""CLI for text-controlled ABO lamp scene generation."""
...
from .product_scene_data import build_instruction_cache
from .product_scene_training import cache_scene_latents, load_scene_config, train_scene_model


def main() -> int:
    parser = argparse.ArgumentParser(description="Train the ABO lamp background generator")
    ...
    if args.command == "cache-instructions":
        ...
        report = train_scene_model(
            ...
            warm_start_checkpoint=(
                args.warm_start_checkpoint.resolve() if args.warm_start_checkpoint else None
            ),
        )
