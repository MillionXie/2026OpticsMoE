...
def main() -> int:
    ...
    train=sub.add_parser("train");train.add_argument("--task",choices=("background","redesign","premium","unified"),required=True);train.add_argument("--data-dir",type=Path,required=True);train.add_argument("--instruction-cache",type=Path,required=True);train.add_argument("--embedding-cache",type=Path,required=True);train.add_argument("--output-dir",type=Path,required=True);train.add_argument("--epochs",type=int,default=20);train.add_argument("--batch-size",type=int,default=16);train.add_argument("--learning-rate",type=float,default=2e-4);train.add_argument("--seed",type=int,default=42);train.add_argument("--device",default="cuda");train.add_argument("--text-width",type=int,default=768);train.add_argument("--intermediate-width",type=int,default=2048);train.add_argument("--text-heads",type=int,default=12);train.add_argument("--warm-start-checkpoint",type=Path)
