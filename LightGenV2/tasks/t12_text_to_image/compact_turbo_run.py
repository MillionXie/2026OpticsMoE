"""CLI for Qwen-conditioned compact one-step Turbo student refinement."""
...
from .compact_turbo_training import train_compact_turbo


def main() -> int:
    parser = argparse.ArgumentParser(description="Refine a compact one-step Turbo UNet")
