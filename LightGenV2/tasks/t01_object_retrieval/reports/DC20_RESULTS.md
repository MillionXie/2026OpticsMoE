...
- 主方法使用负载均衡损失 0.08、importance 损失 0.02、hard-load 损失 0.02，且
  Router 的 load-bias 更新率为 0；最终不存在从未选中的专家。
...
- 服务器正式权重：
  `LightGenV2/tasks/t01_object_retrieval/runs/simulation/moe_router_scale_dc20_seed42/`
