...
下一步[GSAM训练对照](reports/reproduction/GSAM_TRAINING_20260913.md)只改训练梯度，
不增推理参数、不改同尺度融合或光学合同；测试/启动状态以该文档为准。
新.86249251权重的同权重去光已独立复评.84229470，绝对下降.02019781；
完整专家使用率与可视化审计PID648863正在GPU3补做，GSAM PID646567在GPU1，合计两张自有卡。
