...
当前完成并独立核验的光电候选：`moe_alpha40_sam005_seed42`，50轮完成，
best为epoch5 EMA；重载best完整5000张测试CC=0.86133209，独立float64 CC=0.86133204。
alpha=0.430738/0.441092，四专家选择23.34%/26.40%/23.18%/27.08%，无明显坍缩。
仅在原电子残差内部增加6912个空间DW参数，读出头仍85412参数；SAM不增加推理参数。
...
该训练epoch5候选已独立复评完整5000张，float64 CC=0.86172948；尚未完成训练，
KLD/SIM略差，不替换上面的已完成候选。SHA、逐图改善和边界见同一SAM文档。
