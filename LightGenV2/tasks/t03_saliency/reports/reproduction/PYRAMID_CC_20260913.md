...
|组|第1轮CC|第5轮CC|第10轮CC|第15轮CC|
|---|---:|---:|---:|---:|
|fullgrid|.8621423170|.8619539021|.8616568089|.8615773853|
|pyramid|.8620503012|.8618758932|.8615982368|.8616405329|

fullgrid训练CC上升而测试连续下降，已停止，只保留第1轮best、第16轮last，不是完成30轮。
CPU重载core/head全部有限，父529390及530229/530230/530267/530649/530755五个子进程确认退出，
GPU3释放后才用于小batch8试验。停止记录见本run `manual_stop_report.json`。
best SHA `62b3f15f976ea6a8127f58a39f5bf406dba83b152187b0e7c6253bed66923c37`；
last SHA `8c5fad15bd34470690d4b921c6c36bf14fae2a04b8c3b6d62f8ebdc39d9e242f`。
第1轮仅比正式候选高约9e-5且未经独立复评，不据此替换正式候选或声称实质提升。

pyramid第15轮较第10轮略回升，但仍低于起点；保留运行至第20轮观察，不称为持续逐次下降。
其best第1轮SHA `e3c594f2a2bfad2db3a6ca70a0ee95f6d0161ea6b0c8b38ef9cc65b8566b9b86`。
`midrun_state_audit.json`检查结构/同头/alpha合同通过；`midrun_train64_routing_audit.json`
以seed20260913随机抽取64张train，专家次数27/36/24/41、有效专家3.8262、5种Top2组合，全部输出有限。
这不是全测试集路由统计，不用于选择测试子集或变更测试指标。未发现新增推理结构。

### 粗尺度组终止

第20轮CC=.861644225025177，与第15轮几乎持平，仍低于起点与第1轮；未取得所需提升。
因此停止，不写成连续逐轮下降。保留第1轮best和第20轮last，不是完成30轮。
停止前核验UID/完整命令/cwd/PGID，父529392及530221/530222/530257/530645/530689全部确认退出，
GPU5释放后才用于小batch8候选的独立复评。没有删除任何权重或数据。
两个PT的core/head均CPU重载并验证有限；完整记录在`manual_stop_report.json`。
last SHA256 `3205c49371a3deeff31334a651dc48413f2b24b0eede0e66add7c945e907da08`，best SHA同上。
两组均未带来实质改善，不改写已核验的正式.86204960。
