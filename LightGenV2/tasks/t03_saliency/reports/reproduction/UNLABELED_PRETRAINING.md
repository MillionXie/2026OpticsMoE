...
# 位置辅助试验停止记录（2026-09-10补充）

`moe_alpha40_extra_regions_seed42`已停止，预算80轮、最后完整保存第12轮，不能写成完成80轮。
第1/5/10轮完整5000张周期CC分别.8603593936920166/.8607307468414307/.860297267150879；
未超过正式已核验.86204960，也未形成相比旧无辅助组.86071849的实质收益。
best第5轮SHA256 `378fa5f2ad8f0a529579d51067479d9dc73d9b9df84af3fb4fe7120ce27f1705`；
last第12轮SHA256 `bbbb7a9a962736d6d5fd0ccecea87bedffec7bc5ae2b20a081e069995954d5f0`。
停止后两个PT均成功CPU重载；最后一轮非测试轮，last的test_metrics为null是正常行为。
父进程1033718及当时7个子进程均确认退出，GPU0不再显示本任务占用。保留全部数据/权重。
后续固定教师特征基底方案不再使用本试验的额外框标签，见FEATURE_HINTS.md。
