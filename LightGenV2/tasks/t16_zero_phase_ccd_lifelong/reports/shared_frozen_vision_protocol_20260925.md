...
| D2NN 无 replay／测试任务 | EuroSAT | CLEVR | Speech | Physical 无帧差 |
|---|---:|---:|---:|---:|
| 学完 A | 71.77 |  |  |  |
| 学完 B | 10.00 | 76.41 |  |  |
| 学完 C | 10.00 | 50.00 | 60.67 |  |
| 学完 D | 9.98 | 57.96 | 51.96 | 75.16 |

这条链的十个测试单元均来自各阶段**同一份持续更新的 D2NN 相位和同一份单层 Linear**；B/C/D 无旧任务训练样本、无任务头切换。C 阶段对新 Speech 仅达 60.67% 是结果本身的限制，不能把所有旧任务下降都解释为纯粹的遗忘能力差异。
