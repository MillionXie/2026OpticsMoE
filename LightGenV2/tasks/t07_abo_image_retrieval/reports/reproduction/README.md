...
**最新已完成原图复评：正常82.50%=660/800、同权重去光76.25%=610/800，下降6.25个百分点。**
冻结Qwen64为85.125%，差距2.625个百分点。目标83%尚差4张，未达到。
干净TRAIN图库自图排除94.375%=1510/1600，仍有11.875pp训练—测试差距，不宣称过拟合消失。
...
- 400步的anchor1对照原图82.25%/去光76.25%，为`abo200_direct_readout_dropout_20260914`；
  dropout=.2对照未提升。原图复评PID1688116/1678450与CPU拟合均退出；另光学再加热主训练仍运行。
