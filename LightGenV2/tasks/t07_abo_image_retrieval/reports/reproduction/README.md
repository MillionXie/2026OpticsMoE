...
**最新已完成原图复评：正常81.875%=655/800、同权重去光75.50%=604/800，下降6.375个百分点。**
冻结Qwen64为85.125%，差距3.25个百分点。目标83%尚未达到。
干净TRAIN图库自图排除94.6875%=1515/1600，仍有12.8125pp训练—测试差距，不宣称过拟合消失。
