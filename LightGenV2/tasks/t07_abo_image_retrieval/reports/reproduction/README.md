...
**最新独立原图复评：正常83.00%=664/800、同权重去光76.375%=611/800，下降6.625个百分点。**
冻结Qwen64为85.125%，差距2.125个百分点。83%目标已达到，但仅比上一候选多2张，不宣称显著提升。
干净TRAIN图库自图排除94.875%=1518/1600，仍有11.875pp差距，不宣称过拟合消失。
