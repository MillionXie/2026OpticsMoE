...
> CUDA切换流程冒烟`runs/smoke/abo_spin_curriculum_20260913`在物理GPU0 RTX4090运行，PID2211519，使用已ready的40张外部图，1外部轮+1目标轮、各1步。外部一步梯度有限；仍需完成目标/正常去光评估。模型为原2782485参数轻量结构，无新教师loss/电子扩容；真正大池模型训练尚未启动。第71节含命令，不将冒烟当正式新成绩。
