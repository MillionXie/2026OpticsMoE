...
实际scope完成，源码5f561138、本地/服务器440项测试通过：第1轮live83%/EMA82.625%，
最终normal83%/去光76.50%，路由合格、冻结SHA一致，scope_audit.json确认只改14张量。
...
第107节已完成，源码5e9259e2，本地/服务器455项测试；自动教师温度.0270005，
1349个门控TRAIN行参考熵3.2144415，教师校准前6.5166535、后3.2144408。
2步scope未超过83%，PID2796728退出。400步正式温度校准组末期82.375%/TRAIN95.0625%，
最高仍step0原83%，PID2799892退出，不晋升。

另按第106节同配方（不加`--teacher-match-entropy`），只改`--teacher-weight .2`，
